      ...
      breakpoints: {
        setBreakpoint: function () {
          ...
          d && !p
            ...
            : !d && p && (r.addClass(`${i.containerModifierClass}grid`), ((o.grid.fill && 'column' === o.grid.fill) || (!o.grid.fill && 'column' === i.grid.fill)) && r.addClass(`${i.containerModifierClass}grid-column`), e.emitContainerClasses())
  ...
  const J = [
    ...
    function ({ swiper: e, extendParams: t, on: s, emit: a }) {
      ...
      function g(t) {
        ...
        if (
          (v >= e.minTranslate() && (v = e.minTranslate()), v <= e.maxTranslate() && (v = e.maxTranslate()), (i = !!e.params.loop || !(v === e.minTranslate() || v === e.maxTranslate())), i && e.params.nested && s.stopPropagation(), e.params.freeMode && e.params.freeMode.enabled)
        ) {
    ...
    function ({ swiper: e, extendParams: t, on: s, emit: a }) {
      ...
      function p() {
        ...
        if (
          (e.params.loop
            ? ((c = Math.ceil((e.activeIndex - e.loopedSlides) / e.params.slidesPerGroup)), c > i - 1 - 2 * e.loopedSlides && (c -= i - 2 * e.loopedSlides), c > u - 1 && (c -= u), c < 0 && 'bullets' !== e.params.paginationType && (c = u + c))
    ...
    function ({ swiper: e, extendParams: t, on: s }) {
      ...
      const a = (t, s) => {
          ...
          if (
            (l || o ? ((l = l || '0'), (o = o || '0')) : e.isHorizontal() ? ((l = n), (o = '0')) : ((o = n), (l = '0')), (l = l.indexOf('%') >= 0 ? parseInt(l, 10) * s * r + '%' : l * s * r + 'px'), (o = o.indexOf('%') >= 0 ? parseInt(o, 10) * s + '%' : o * s + 'px'), null != c)
          ) {
    ...
    function ({ swiper: e, extendParams: t, on: s, emit: a }) {
      ...
      function E() {
        ...
        u.$slideEl &&
          ...
          (u.$imageEl && u.$imageEl.transform('translate3d(0,0,0) scale(1)'), u.$imageWrapEl && u.$imageWrapEl.transform('translate3d(0,0,0)'), (t.scale = 1), (p = 1), (u.$slideEl = void 0), (u.$imageEl = void 0), (u.$imageWrapEl = void 0))
      }
      function T(t) {
        const s = e.zoom,
          a = e.params.zoom
      ...
      function O() {
        ...
        s.gestures
          ...
          : 'touchstart' === e.touchEvents.start && (e.$wrapperEl.on(e.touchEvents.start, r, w, a), e.$wrapperEl.on(e.touchEvents.move, r, b, i), e.$wrapperEl.on(e.touchEvents.end, r, x, a), e.touchEvents.cancel && e.$wrapperEl.on(e.touchEvents.cancel, r, x, a)),
      ...
      function I() {
        ...
        s.gestures
          ...
          : 'touchstart' === e.touchEvents.start && (e.$wrapperEl.off(e.touchEvents.start, r, w, a), e.$wrapperEl.off(e.touchEvents.move, r, b, i), e.$wrapperEl.off(e.touchEvents.end, r, x, a), e.touchEvents.cancel && e.$wrapperEl.off(e.touchEvents.cancel, r, x, a)),
        ...
        s('touchStart', (t, s) => {
          e.zoom.enabled &&
            (function (t) {
              ...
              u.$imageEl &&
                0 !== u.$imageEl.length &&
                (m.isTouched || (s.android && t.cancelable && t.preventDefault(), (m.isTouched = !0), (m.touchesStart.x = 'touchstart' === t.type ? t.targetTouches[0].pageX : t.pageX), (m.touchesStart.y = 'touchstart' === t.type ? t.targetTouches[0].pageY : t.pageY)))
            })(s)
        }),
        s('touchEnd', (t, s) => {
          e.zoom.enabled &&
    ...
    function ({ swiper: e, extendParams: t, on: s, emit: a }) {
      t({
        lazy: { checkInView: !1, enabled: !1, loadPrevNext: !1, loadPrevNextAmount: 1, loadOnTransitionStart: !1, scrollingElement: '', elementClass: 'swiper-lazy', loadingClass: 'swiper-lazy-loading', loadedClass: 'swiper-lazy-loaded', preloaderClass: 'swiper-lazy-preloader' },
      }),
        (e.lazy = {})
      let i = !1,
        n = !1
